...
public class RealCreateCourse extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_real_create_course, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        Button createCourse = view.findViewById(R.id.createcoursebutton);
        TextView textView = view.findViewById(R.id.courseNameForCreation2);
